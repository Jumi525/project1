...
const Dashboardpage = () => {
  return (
    <main className="bg-green-600/5 backdrop-blur-2xl min-h-screen py-4 flex flex-col justify-between relative overflow-x-hidden">
...
73 38 102 59 93 68 -3 3 -9 1 -13 -5z"
        ...
        <h1 className="font-bold text-3xl pt-6 pb-3">Ahmed Najmudeen</h1>
        <div className="flex flex-wrap  gap-3 justify-center">
          <DashboardCard title="Revenue" heading="$3,476" increase="+10%" />
          <DashboardCard title="Booking" heading="126" increase="+34" />
      ...
      <div className="h-[400px] w-[400px] absolute top-11 left-11 -z-10 bg-red-400 rounded-full blur-3xl"></div>
      <div className="h-[400px] w-[400px] absolute bottom-7 right-7 -z-10 bg-red-400 rounded-full blur-3xl"></div>
    </main>
  );
};
