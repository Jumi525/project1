...
73 38 102 59 93 68 -3 3 -9 1 -13 -5z"
      ...
      <section className=" hidden md:flex md:flex-grow">
        <NavLink props="md:flex-row md:w-full md:flex-grow md:max-w-[500px] md:mx-auto md:justify-between md:text-[#EAD494]" />
      </section>
      <div className="flex gap-2 items-center ">
        <Sheet>
          <SheetTrigger className="md:hidden">
            <AlignRight className=" text-[#9A845C]/80" />
          </SheetTrigger>
          <SheetContent
            side={"left"}
...
73 38 102 59 93 68 -3 3 -9 1 -13 -5z"
        ...
        <Link href="/login" className="bg-[#9A845C] px-2 py-1 rounded-md">
          Login
        </Link>
      </div>
    </div>
